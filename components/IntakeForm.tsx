...
export default function IntakeForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:karen@paleofoundation.com?subject=${subject}&body=${body}`;
    setSubmitted(true);
  };
    ...
    return (
      <div className="bg-sage/5 border border-sage/20 rounded-lg p-8 text-center">
        ...
        <p className="text-sm text-ink-light">
          ...
          <a href="mailto:karen@paleofoundation.com" className="text-accent underline underline-offset-2">
