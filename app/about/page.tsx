...
export const metadata: Metadata = {
  title: 'About',
  description:
    'The story of Karen Pendergrass: from chronic illness and self-directed research to founding six organizations at the intersection of microbiome science, food safety, and regulatory innovation.',
  alternates: {
    canonical: '/about',
  },
};
    ...
    <div className="page-enter">
      ...
      <article className="max-w-3xl mx-auto px-6 md:px-10 py-16 md:py-20 prose">
        <ScrollReveal animation="fade-in">
          <p>
            I run six organizations. I live in Parekklisia, Cyprus, in the Limassol
            ...
            manufacturers worldwide. I am building platforms to democratize microbiome
            knowledge and connect animal sanctuaries with sponsors. And I got here because
        ...
        <ScrollReveal animation="slide-up">
          <h2>The six entities</h2>
        </ScrollReveal>

        <ScrollReveal animation="fade-in">
          <p>Everything I do rolls up into six organizations:</p>
          ...
          <p>
            ...
            ): Open-access platform making disease-associated microbiome signatures
            and microbial data accessible to researchers, clinicians, and the public.{' '}
            <strong>
              <Link href="/ventures" className="text-accent">
                Gardens of St. Gertrude
              </Link>
