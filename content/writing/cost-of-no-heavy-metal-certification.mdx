...
canonicalUrl: https://www.karenpendergrass.com/writing/cost-of-no-heavy-metal-certification
openGraph:
  type: article
...
California's [Proposition 65](https://www.p65warnings.ca.gov/) has become a litigation engine. Any food product with detectable heavy metals can trigger exposure warnings, class action suits, or both. For companies without third-party certification, defense costs are astronomical because you're essentially defending against the claim that "we didn't know." This is exactly the failure mode the [certification framework for infant foods](/writing/certification-framework-infant-foods-heavy-metals) is designed to prevent.
