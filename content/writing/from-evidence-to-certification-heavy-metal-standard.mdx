...
canonicalUrl: "https://karenpendergrass.com/writing/from-evidence-to-certification-heavy-metal-standard"
openGraph:
  title: "From Evidence to Certification: How a Heavy-Metal Standard Actually Gets Built"
  ...
  type: "article"
  url: "https://karenpendergrass.com/writing/from-evidence-to-certification-heavy-metal-standard"
---
...
The reason most certifications erode into marketing is that they quietly merge the three stages. The same party gathers the evidence, sets the limit, and issues the seal, with none of it public, and asks you to trust the result. That's not a standard. It's a brand vouching for itself.
...
*Explore the layers: the public evidence at the [Heavy Metal Index](https://heavymetalindex.com), the standard at [HMTc](/frameworks/hmtc), and certified products at [Heavy Metal Tested](https://heavymetalcertified.com).*
