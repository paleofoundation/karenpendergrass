...
status: "publish"
coverImage: ""
excerpt: "Antimicrobial resistance is on track to kill ten million people a year by 2050, and the one therapy with the mechanism to actually answer it, bacteriophages, receives a rounding error of the world's research funding. That is not an accident but an incentive structure, and it is going to break."
...
canonicalUrl: "https://karenpendergrass.com/writing/phage-therapy-the-answer-no-one-is-funding"
openGraph:
  ...
  type: "article"
  url: "https://karenpendergrass.com/writing/phage-therapy-the-answer-no-one-is-funding"
---

> **Update, June 2026:** [phagecocktails.com](https://phagecocktails.com) is now live, and I wrote about what it is and why [here](/writing/phagecocktails-com-is-live). There is also a running summary at [/phage](/phage). The essay below is the original case for the domain, written before I built it.

I own [phagecocktails.com](https://phagecocktails.com). I bought it years ago, when most people had never heard the word, because I could already see where this was going. When I first wrote this, I had not built anything on it yet, and I was honest about why: I was still working out what the right thing to build was, because the opportunity is so large and so neglected that it is genuinely hard to know where to put the lever. That tension, enormous promise against near-zero attention, is the whole story of phage therapy. So let me lay out the case for why I bought the domain, and why I think bacteriophages are not a billion-dollar idea but a trillion-dollar one.
