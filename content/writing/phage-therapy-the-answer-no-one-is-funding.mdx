...
Every one of these is a compassionate-use story. A person had to be nearly dead, every antibiotic had to fail first, and a small band of researchers had to improvise a treatment by hand. That is not the profile of a fringe idea that does not work; it is the profile of a working therapy that no system has been built to deliver.
