...
description: "Neonatal NEC angle: nickel in formula may drive nickel-cofactored virulence in preterm guts, and why infant heavy-metal testing standards matter."
...
canonicalUrl: "https://www.karenpendergrass.com/writing/nickel-necrotizing-enterocolitis"
openGraph:
  title: "The Metal in the Formula: How Nickel May Be Driving Necrotizing Enterocolitis in Preterm Infants"
  description: "Neonatal NEC angle: nickel in formula may drive nickel-cofactored virulence in preterm guts, and why infant heavy-metal testing standards matter."
  type: "article"
  url: "https://www.karenpendergrass.com/writing/nickel-necrotizing-enterocolitis"
---
...
The NEC/nickel hypothesis is a specific instance of a broader pattern that I've been researching across multiple conditions through the field of [microbial metallomics](/writing/microbial-metallomics-and-heavy-metal-contamination). Heavy metals don't just poison host cells. They reshape the microbial ecosystem by providing virulence-enabling cofactors to pathogenic bacteria while the host derives no benefit from their presence.
...
The World Health Organization's top priority pathogens, the bacteria they are most concerned about in terms of antibiotic resistance, are all nickel-dependent for their virulence factors. This is not a coincidence but a signal that nickel contamination in the food supply has consequences far beyond what current toxicology models account for.
...
Given what we know about nickel-dependent virulence factors, about the preterm gut's vulnerability, and about the mechanism by which dietary nickel could activate the very bacteria that cause NEC, the question is not whether nickel should be tested, but why it isn't tested already.
