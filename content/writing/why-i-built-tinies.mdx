...
<a href="https://tinies.com" target="_blank" rel="noopener noreferrer">Tinies</a> is a pet services marketplace. When someone books a service through Tinies, approximately 90% of the booking commission funds animal rescue operations in Cyprus. This is not a donation. It is not a pledge. It is a structural feature of how revenue is allocated, written into the operating model, not decided month to month based on what is left over.
...
I wrote about this model in detail on the Tinies blog. The [90% Model](https://tinies.com/blog/the-90-percent-model) explains how the revenue allocation works and why structural commitment is different from discretionary giving. [What If We're Thinking About This the Wrong Way](https://tinies.com/blog/what-if-were-thinking-about-this-the-wrong-way) makes the broader argument that the current sanctuary model is a design flaw, not a funding shortfall.
...
I laid out the acquisition logic in [What If the Land Paid for Itself](https://tinies.com/blog/what-if-the-land-paid-for-itself) and revisited the Cause Hotel thesis in [The Cause Hotel: What We Think Now](https://tinies.com/blog/the-cause-hotel-yc-pitch-what-we-think-now).
...
I wrote the full analysis in [Cyprus Could Turn Its Cat Crisis Into a €100 Million Tourism Industry](https://tinies.com/blog/cyprus-cat-crisis-tourism-industry).
