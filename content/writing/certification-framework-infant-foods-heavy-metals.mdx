...
canonicalUrl: "https://www.karenpendergrass.com/writing/certification-framework-infant-foods-heavy-metals"
openGraph:
  ...
  type: "article"
  url: "https://www.karenpendergrass.com/writing/certification-framework-infant-foods-heavy-metals"
---
...
ALARA ("As Low As Reasonably Achievable") comes from nuclear safety. It's not about zero risk but about systematic reduction. You measure, you set targets, you innovate to hit them, and you verify the results.
...
This isn't perfect safety but **defensible** safety: the kind you can explain to regulators, parents, and lawyers.

### 2. The Law: Proposition 65 and FDA Authority

California's [Proposition 65](https://www.p65warnings.ca.gov/) warning requirement is a sword hanging over food companies. A single non-compliant batch can trigger years of litigation and warnings that devastate sales, whether or not the product actually harms anyone. For the business case behind getting ahead of this, see [the cost of having no heavy-metal certification](/writing/cost-of-no-heavy-metal-certification), and for the regulatory tell most people are missing, see [California's quiet admission that nickel can harm a developing baby](/writing/california-prop-65-nickel-developmental-toxicity).
