...
I began raising this alarm five years before the European Union began regulating nickel in foods. Three of my published papers document the mechanisms: nickel as a catalytic driver of necrotizing enterocolitis in preterm infants (https://doi.org/10.5281/zenodo.18200348), age-window toxicokinetic vulnerability in vegetable-based baby foods (https://doi.org/10.5281/zenodo.18366816), and the mechanistic role of heavy metals and microbial metallomics in the US obesity epidemic (https://doi.org/10.5281/zenodo.18434951). The obesity paper is particularly important: it argues that the metabolic disruption driving population-level obesity is not primarily behavioral but mechanistic, mediated through heavy metal-driven microbial dysbiosis.
